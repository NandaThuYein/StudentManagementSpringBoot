...
<body>
    ...
    <div id="sub_content">
        <form action="#" th:action="@{/UpdateUserServlet}" method="post" th:object="${bean}">
        ...
        <div class="row mb-2">
		   ...
		   <!-- <form:errors path="*" cssClass="errorblock" element="div" />  -->
        			...
        			<div class="row mb-4">
						...
						<div class="col-md-4">
							<input type="text" th:field="*{userId}" class="form-control" id="email" placeholder="Enter your Id" readonly="true" />
        ...
        <div class="row mb-4">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                               ...
                               <h5 style="color: rgb(127, 209, 131);">Are you sure you want to Updated !</h5>
                            </div>
            ...
            <button type="button" class="btn btn-secondary col-md-2 " onclick="location.href = '/SearchUser';">
                Back
            </button>
        </div>
        </div>
