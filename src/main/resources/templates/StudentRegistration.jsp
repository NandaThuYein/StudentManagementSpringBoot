...
<body>
    ...
    <div id="sub_content">
        <form action="#" th:action="@{/AddStudentServlet}" method="post" th:object="${bean}">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <span class="span1 text-danger" th:if="${#fields.hasErrors('studentEducation')}" th:errors="*{studentEducation}"></span>
                </div>
            </div>
            <fieldset class="row mb-4">
                <div class="col-md-2"></div>
